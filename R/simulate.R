...
likelihood.inference <- function(data) {
    ...
    suppressWarnings(r_lower <- tryCatch(uniroot(r_lrt, c(0.05, r_mle))$root, error = function(e) NA))
    ...
    suppressWarnings(ip_sd_lower <- tryCatch(uniroot(ip_sd_lrt, c(1, ip_sd_mle))$root, error = function(e) NA))
    suppressWarnings(ip_sd_upper <- tryCatch(uniroot(ip_sd_lrt, c(ip_sd_mle, 10))$root, error = function(e) NA))
